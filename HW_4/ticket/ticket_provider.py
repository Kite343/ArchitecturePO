...
class TicketProvider:
    ...
    def __init__(self, ticket_repository: TicketRepository=TicketRepository()) -> None:
        self._ticket_repository = ticket_repository

    def create_ticket(self, price: int, 
                  place: int, is_valid: bool = True,
                  dateTime=datetime.date.today()):
        self._ticket_repository.create(price, place, is_valid, dateTime)
